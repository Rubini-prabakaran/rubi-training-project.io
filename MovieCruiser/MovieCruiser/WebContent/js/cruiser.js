function validateMovieListForm()
{
var title=document.forms["MovieListForm"]["title"].value;
if(title=="")
{
...
var gross=document.forms["MovieListForm"]["gross"].value;
if(isNaN(gross)){
...
var dateOfLaunch=document.forms["MovieListForm"]["dateOfLaunch"].value;
if(dateOfLaunch==""){
