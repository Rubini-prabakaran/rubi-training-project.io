...
public class CartDaoSqlImpl implements CartDao {
	...
	public static final String DELETE_CART_ITEM = "delete from cart where ct_us_id=? and ct_pr_id=? limit 1";
	...
	public void removeCartItem(long userId, long MenuItemId) {
		...
		ResultSet resultSet = null;
		try {
			statement = connection.prepareStatement(DELETE_CART_ITEM);
			statement.setLong(1, userId);
			statement.setLong(2, MenuItemId);
			int noOfRows = statement.executeUpdate();
			System.out.println("Number of Rows Affected" + noOfRows);
